# Travel AI: Documentation Crawler and RAG Agent
...
```bash
git clone https://github.com/innova25/Travel-agent.git
cd Travel_agent/BasicRAG-agent
```
...
```bash
python crawl_travel_ai_docs.py
```
...
You can configure chunking parameters in `crawl_travel_ai_docs.py`:
```python
...
- `crawl_travel_ai_docs.py`: Documentation crawler and processor
- `Travel_ai_expert.py`: RAG agent implementation
